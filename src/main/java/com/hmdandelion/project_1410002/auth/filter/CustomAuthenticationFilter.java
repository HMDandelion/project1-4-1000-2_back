...
public class CustomAuthenticationFilter extends AbstractAuthenticationProcessingFilter {
    ...
    public Authentication attemptAuthentication(HttpServletRequest request, HttpServletResponse response) throws AuthenticationException, IOException, ServletException {
        ...
        String employeeNo = bodyMap.get("employeeNo");
        String password = bodyMap.get("password");

        log.info("CustomAuthenticationFilter employeeNo : {}", employeeNo);
        log.info("CustomAuthenticationFilter password : {}", password);

        UsernamePasswordAuthenticationToken authenticationToken = new UsernamePasswordAuthenticationToken(employeeNo, password);
